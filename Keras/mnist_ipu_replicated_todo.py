...
# Todo: Step 1 - Set number of IPUs and replicas.
num_ipus = num_replicas = FIXME
...
# Todo: Step 2 - Set the steps per execution and data length for training.
train_data_len = x_train.shape[0]
train_steps_per_execution = FIXME
train_data_len = FIXME
x_train, y_train = FIXME

# Todo: Step 3 - Set the steps per execution and data length for testing.
test_data_len = x_test.shape[0]
test_steps_per_execution = FIXME
test_data_len = FIXME
x_test, y_test = FIXME

# Todo: Step 4 - add number of IPUs in the IPU configuration.
...
with strategy.scope():
    ...
    # Todo: Step 5 - Add training steps per execution.
    model.compile(
        "sgd",
    ...
    # Todo: Step 6 - Add testing steps per execution.
    model.compile(
        "sgd",
        "categorical_crossentropy",
        metrics=["accuracy"],
