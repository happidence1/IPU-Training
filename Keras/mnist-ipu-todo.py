...
# Todo: Step 1 - import the TensorFlow IPU module.
...
# Todo: Step 2 - Write an utility function, which computes the largest number, no larger than a given number, which is divisible by a given divisor.
# Write your code below  
...
# Todo: Step 3 - Use the utility function in Step 2 to adjust the dataset lengths to be divisible by the batch size
# Write your code below



# Todo: Step 4 - Create an IPU session configuration
# Write your code below



# Todo: Step 5 - Create IPU strategy
# Write your code below
...
# Todo: Step 6 - Wrap the model within the IPU strategy scope
# Write your code below
